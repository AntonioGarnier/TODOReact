...
## Technologies
  ...
  |      Technologies       |     Docs      |
  | ----------- | ------------        | ---- |
  | React | [GH](https://github.com/facebook/react) / [Page](https://reactjs.org/) |
  | Redux | [GH](https://github.com/reduxjs/redux) / [Page](https://redux.js.org/) |
  | ReactiveX |[GH](https://github.com/ReactiveX/rxjs) / [Page](http://reactivex.io/) |
  | Redux-Observable | [GH](https://github.com/redux-observable/redux-observable) / [Page](https://redux-observable.js.org/) |
  | Immutable | [GH](https://github.com/facebook/immutable-js/) / [Page](https://facebook.github.io/immutable-js/) |
